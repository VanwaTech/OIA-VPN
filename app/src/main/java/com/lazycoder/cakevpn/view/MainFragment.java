...
public class MainFragment extends Fragment implements View.OnClickListener, ChangeServer {
    ...
    private void initAds() {
        MobileAds.initialize(requireContext(), new OnInitializationCompleteListener() {
            ...
            public void onInitializationComplete(InitializationStatus initializationStatus) {
                Log.d("MainFragment","onInitializationComplete");
    ...
    private void initInterstitialAd(){
        ...
        InterstitialAd.load(requireContext(), getString(R.string.interstitial_ad_id), adRequest,
    ...
    public void setStatus(String connectionState) {
        ...
        switch (connectionState) {
            ...
            case "CONNECTED":
                ...
                break;
            case "WAIT":
                binding.logTv.setText("Connecting to VanwaTech Server");
                break;
            case "AUTH":
                binding.logTv.setText("Establishing Encrypted Link");
                break;
            case "RECONNECTING":
                status("connecting");
